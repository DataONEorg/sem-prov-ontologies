...
-------------- | --------------------------------------------------------------------------------  | ---------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------- | ------- | -------------------------
A              | Testing of annotation algorithms to ensure correct positives (requested by Xixi). | 45                                             | - Selected datasets that were contributed by three Long Term Ecological Research (LTER): Andrews Forest (AND), Konza Prairie (KNZ), and Santa Barbara Coastal (SBC) in DataONE as of YYYY-MM-DD.          |                                     |         |
               |                                                                                   |                                                | - These selected datasets are known to be relevant to carbon cycling and have been manually reviewed and evaluated.                                                                                       |                                     |         |           
B              | Expansion of Test Corpus A                                                        | 201                                            | - This test corpus is constructed just like Test Corpus A, but with selected datasets from more LTER sites.                                                                                               |                                     |         |
               |                                                                                   |                                                | - Selected Datasets were contributed by a total of 14 site (only the acronyms are provides as follows): HFR, KBS, GCE, BNZ, SEV, VCR, CDR, CAP CCE, CWT, FCE, MCR, NTL, PAL in DataONE as of YYYY-MM-DD.  |                                     |         |
               |                                                                                   |                                                | - These selected datasets are also known to be relevant to carbon cycling and have been manually reviewed and evaluated.                                                                                  |                                     |         |               
C              | Query code development                                                            | 156                                            | - **All** the datasets that were contributed by Long Term Ecological Research (LTER) Santa Barbara Coastal (SBC) in DataONE as of YYYY-MM-DD.                                                             |                                     |         |          
...
Ca             |                                                                                   |                                                | - Corpus C plus datasets derived by EcoTrends project in DataONE as of YYYY-MM-DD                                                                                                                         |                                     |         |   
D              | Query code vetting                                                                | est 500                                        | - **All** the datasets that were contributed by three Long Term Ecological Research (LTER) sites: Andrews Forest (AND), Konza Prairie (KNZ), and Santa Barbara Coastal (SBC) in DataONE as of YYYY-MM-DD. |                                     |         |                                
...
E              | First run of query code, precision and recall analysis                            | est 4000                                       | - All datasets contributed by ~13 LTER sites (see corpus B)                                                                                                                                               |                                     |         |                                                                            
